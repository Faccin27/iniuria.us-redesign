    ...
    >
      <div className="container mx-auto px-4 h-full flex items-center justify-between">
        <div className="flex items-center pt-2">
          <Image src="/images/logo.png" alt="Iniuria.us" width={700} height={0} className="h-full w-full" />
        </div>
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <a href="#games" className="text-white hover:text-purple-400 transition-colors">
            Games
          </a>
          <a href="#video" className="text-white hover:text-purple-400 transition-colors">
            Demo
          </a>
          <a href="#about" className="text-white hover:text-purple-400 transition-colors">
            About
          </a>
          <Button className="bg-purple-600 hover:bg-purple-700 text-white border-0">Get Started</Button>
        </nav>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-black/95 backdrop-blur-md border-t border-purple-500/30">
          <nav className="container mx-auto px-4 py-6 flex flex-col space-y-4">
            ...
            <Button className="bg-purple-600 hover:bg-purple-700 text-white border-0 w-full">Get Started</Button>
          </nav>
        </div>
      )}
    </header>
